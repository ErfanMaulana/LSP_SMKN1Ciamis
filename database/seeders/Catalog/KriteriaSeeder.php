...
class KriteriaSeeder extends Seeder
{
    ...
    {
        if (DB::table('kriteria')->where('deskripsi_kriteria', 'Konsep data dan struktur data diidentifikasi sesuai dengan konteks permasalahan.')->exists()) {
            $this->command->info('Kriteria RPL sudah ada. Seeder dilewati.');
            return;
        }
