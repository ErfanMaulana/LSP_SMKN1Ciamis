...
@section('title', 'Panduan Asesi')
@section('page-title', 'Panduan Asesi')

@section('styles')
<style>
    .guide-hero {
        background: linear-gradient(135deg, #0f4c81 0%, #0073bd 100%);
        color: white;
        border-radius: 14px;
        padding: 24px;
        margin-bottom: 18px;
...
<div class="guide-hero">
    <h2><i class="bi bi-journal-bookmark"></i> Panduan Penggunaan Panel Asesi</h2>
    <p>
        Ikuti panduan ini agar proses sertifikasi berjalan lancar, mulai dari melengkapi data,
        mengerjakan asesmen mandiri, hingga memantau hasil rekomendasi asesor.
    </p>
</div>
        ...
        <article class="guide-card">
            <div class="guide-body">
                ...
                <p style="font-size:13px;color:#475569;line-height:1.7;margin:0;">
                    Konten panduan untuk peran asesi belum diatur. Silakan tambahkan melalui panel admin.
                </p>
            </div>
        </article>
    @endforelse
...
<div class="notes-card">
    ...
    <p>
        Isi asesmen mandiri dengan jujur dan konsisten. Data ini akan membantu asesor memberi
        rekomendasi yang tepat untuk proses sertifikasi Anda.
    </p>
</div>
