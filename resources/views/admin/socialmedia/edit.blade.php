        ...
        <form action="{{ route('admin.socialmedia.update', $socialMedia->id) }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name', $socialMedia->name) }}" placeholder="Contoh: Instagram" class="form-control @error('name') is-invalid @enderror" required>
                    @error('name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="url" value="{{ old('url', $socialMedia->url) }}" placeholder="https://www.instagram.com/smkn1ciamis" class="form-control @error('url') is-invalid @enderror" required>
                    @error('url')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
