...
<style>
    ...
    .user-avatar {
        ...
        background: linear-gradient(135deg,#0073bd,#005a94);
            ...
            <tr>
                ...
                <td>
                    <div class="action-btns">
                        <a href="{{ route('admin.admin-management.edit', $adminItem) }}" class="btn btn-sm btn-outline-primary" title="Edit">
                            <i class="bi bi-pencil"></i>
                        </a>
                        @if($adminItem->id !== Auth::guard('admin')->id())
                        <button class="btn btn-sm btn-outline-danger" title="Hapus"
                                onclick="confirmDelete({{ $adminItem->id }}, '{{ $adminItem->name }}')">
