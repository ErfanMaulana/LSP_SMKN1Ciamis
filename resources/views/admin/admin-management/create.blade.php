    ...
    <div class="card">
        <div class="card-body">
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            value="{{ old('name') }}" placeholder="cth: Ahmad Fauzi" required autofocus>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="username" name="username"
                            ...
                            value="{{ old('username') }}" placeholder="cth: ahmadfauzi" required>
                        @error('username')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text">Huruf, angka, dan underscore.</small>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email"
                        ...
                        value="{{ old('email') }}" placeholder="cth: ahmad@example.com" required>
                    @error('email')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-section">
                ...
                @if(!empty($superAdminExists) && $superAdminExists)
                    <p style="font-size:12px;color:#b45309;margin-bottom:12px;">
                        Role Super Admin sudah dipakai. Sistem hanya mengizinkan 1 akun Super Admin.
                    </p>
                @endif

                <div class="role-list">
                    @foreach($roles as $role)
                    @if(!empty($superAdminExists) && $superAdminExists && !empty($role->is_super_admin))
                        @continue
                    @endif
