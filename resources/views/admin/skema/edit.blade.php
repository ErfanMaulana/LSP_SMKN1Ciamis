...
<style>
    ...
    .invalid-feedback.kode-unit-feedback {
        display: block;
    }
...
<div class="page-header">
    ...
    <form action="{{ route('admin.skema.update', $skema->id) }}" method="POST" id="skemaForm">
        ...
        <div class="card">
            <div class="card-body">
                <div class="section-label">Informasi Skema</div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="jurusan_id" name="jurusan_id" class="form-control">
                            ...
                            @foreach($jurusans as $jurusan)
                                <option value="{{ $jurusan->ID_jurusan }}" {{ old('jurusan_id', $skema->jurusan_id) == $jurusan->ID_jurusan ? 'selected' : '' }}>
