...
<div class="form-card">
    <h3><i class="bi bi-calendar-check" style="color:#0061a5;"></i> Edit Jadwal Uji Kompetensi</h3>
    ...
    <form method="POST" action="{{ route('admin.jadwal-ujikom.update', $jadwal->id) }}">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                <label>TUK <span class="required">*</span></label>
            ...
            <div class="form-section-title"><i class="bi bi-people"></i> Peserta & Status</div>
        ...
        <div style="margin-top: 24px;">
            ...
            <div id="peserta-placeholder" style="padding:16px 0; color:#94a3b8; font-size:13px; display:none;">
            ...
            <div id="peserta-wrapper">
                <div class="peserta-section">
                    <div class="peserta-header">
                        ...
                        <span class="peserta-counter" id="peserta-counter">0 / {{ $jadwal->kuota }} dipilih</span>
                    </div>
    ...
    <form method="POST" action="{{ route('admin.jadwal-ujikom.destroy', $jadwal->id) }}"
          style="margin-top:-48px; text-align:right;"
          onsubmit="return confirm('Yakin ingin menghapus jadwal ini?')">
        @csrf @method('DELETE')
        <button type="submit" class="btn-delete" style="float:right;">
...
let allAsesi      = [];
let selectedNiks  = new Set(@json($selectedNiks ?? []));
...
function togglePeserta(nik, row) {
    ...
    const k = getKuota();
    if (!cb.checked && selectedNiks.size >= k && k > 0) return;
