...
@section('page-title', 'Add New Jurusan')

@section('content')
<div class="form-container">
    <div class="form-header">
        <div>
            <h2>Add New Jurusan</h2>
            <p class="subtitle">Create a new academic program or major</p>
        </div>
            ...
            <form action="{{ route('admin.jurusan.store') }}" method="POST">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle"></i> Save Jurusan
                    </button>
                </div>
            </form>
        </div>
