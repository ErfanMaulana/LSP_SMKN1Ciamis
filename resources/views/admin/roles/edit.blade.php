        ...
        <div class="card-body">
            <div class="form-section">
                ...
                @if($role->is_super_admin)
                    <div class="alert alert-warning" style="background:#fef3c7;color:#b45309;border:1px solid #fde68a;margin-bottom:20px;">
                        <i class="bi bi-shield-check"></i> Role Super Admin memiliki semua permission secara otomatis.
                    </div>
                @endif
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="display_name" name="display_name"
                            ...
                            value="{{ old('display_name', $role->display_name) }}" required autofocus>
                        @error('display_name')
...
<style>
    ...
    .permission-group-header { padding: 12px 16px; background: #f1f5f9; border-bottom: 1px solid #e2e8f0; }
    .group-toggle {
    ...
    input[type="checkbox"] { width: 16px; height: 16px; accent-color: #0073bd; cursor: pointer; flex-shrink: 0; }
