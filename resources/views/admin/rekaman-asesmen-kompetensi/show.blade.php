...
<div class="top-actions">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;">
        <a href="{{ route('admin.rekaman-asesmen-kompetensi.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Kembali</a>
        @if(Auth::guard('admin')->user()->hasPermission('rekaman-asesmen-kompetensi.edit'))
            <a href="{{ route('admin.rekaman-asesmen-kompetensi.edit', $item->id) }}" class="btn btn-primary"><i class="bi bi-pencil-square"></i> Edit</a>
        @endif
    </div>
</div>
...
<div class="detail-card">
    <div class="meta-grid">
        ...
        <div class="meta-item" style="grid-column:1 / -1;"><div class="label">Komentar/Observasi Asesor</div><div class="value" style="font-weight:500;">{{ $item->komentar_observasi ?: '-' }}</div></div>
    </div>
</div>
