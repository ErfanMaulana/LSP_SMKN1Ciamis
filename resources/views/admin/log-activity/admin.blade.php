...
<form method="GET" class="toolbar">
    ...
    <a href="{{ route('admin.log-activity.admin.export', ['q' => $search, 'module' => $module ?? '', 'action' => $action ?? '']) }}" class="btn btn-export">Export CSV</a>
    ...
    <table class="log-table">
        <thead>
            <tr>
                ...
                <th class="col-nama">Nama Admin</th>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="8" class="empty-row">Belum ada data log admin.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
