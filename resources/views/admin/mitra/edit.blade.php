...
<div class="form-container">
    <div class="form-header">
        <div>
            <h2>Edit Mitra</h2>
            <p class="subtitle">Perbarui informasi mitra dan MOU</p>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.mitra.update', $mitra->no_mou) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="date" 
                               ...
                               value="{{ old('tanggal_mou', $mitra->tanggal_mou) }}">
                        @error('tanggal_mou')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" 
                               ...
                               value="{{ old('tanggal_berakhir', $mitra->tanggal_berakhir) }}">
                ...
                <div class="info-box">
                    ...
                    <div>
                        ...
                        <p>Mitra ini dibuat pada {{ $mitra->created_at->format('d M Y, H:i') }}. Terakhir diperbarui {{ $mitra->updated_at->format('d M Y, H:i') }}.</p>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle"></i> Update Mitra
                    </button>
                </div>
            </form>
        </div>
