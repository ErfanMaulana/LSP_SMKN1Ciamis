...
@section('content')
    <div class="page-header">
        ...
        <div style="display:flex; gap:10px;">
            <a href="{{ route('asesor.umpan-balik.export', [$asesi->NIK, $skema->id]) }}" class="btn-back"
                style="background:#0073bd; color:#fff; border-color:#0073bd;">
                <i class="bi bi-download"></i> Export FR.AK.03(.doc)
            </a>
