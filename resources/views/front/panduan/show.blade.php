        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-8 xl:col-span-9 space-y-4">
                @forelse($content['steps'] as $step)
                    <article class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                ...
                @empty
                    <article class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Konten Belum Tersedia</h3>
                ...
                @if($activeSection === 'overview')
                    <article class="bg-blue-50 border border-blue-100 rounded-xl p-6">
